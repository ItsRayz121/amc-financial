      ...
      >
        ...
        <div className="p-6 border-t border-base-border">
          ...
          <div className="flex items-center justify-center gap-3 mb-4">
            <a href={SITE_CONFIG.social.whatsapp} target="_blank" rel="noopener noreferrer" onClick={onClose}
               className="w-9 h-9 rounded-lg bg-base-elevated border border-base-border flex items-center justify-center text-[#25D366] hover:border-[#25D366]/30 transition-all duration-250"
            ...
            <a href={SITE_CONFIG.social.telegram} target="_blank" rel="noopener noreferrer" onClick={onClose}
               className="w-9 h-9 rounded-lg bg-base-elevated border border-base-border flex items-center justify-center text-[#2AABEE] hover:border-[#2AABEE]/30 transition-all duration-250"
            ...
            <a href={SITE_CONFIG.social.instagram} target="_blank" rel="noopener noreferrer" onClick={onClose}
               className="w-9 h-9 rounded-lg bg-base-elevated border border-base-border flex items-center justify-center text-[#E1306C] hover:border-[#E1306C]/30 transition-all duration-250"
