      ...
      <div className="section-container py-10 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <span className="inline-flex items-center gap-1.5 text-xs font-semibold font-sans text-emerald bg-emerald-muted border border-emerald/20 px-3 py-1.5 rounded-full">
            ...
            <ul className="flex flex-col gap-2.5">
              {NAV_ITEMS.map((item) => (
                <li key={item.href}>
                  <a
                    href={item.href}
                    className="text-sm text-text-muted hover:text-gold font-sans transition-colors duration-250"
                  >
                    {item.label}
                  </a>
                </li>
        ...
        <div className="flex items-center gap-3 mt-10">
          <SocialIcon href={SITE_CONFIG.social.whatsapp} label="WhatsApp Community">
          ...
          <SocialIcon href={SITE_CONFIG.social.telegram} label="Telegram Community">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
