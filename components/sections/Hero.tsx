  ...
  return (
    ...
    >
      ...
      <div className="section-container relative z-10 flex flex-col items-center text-center pt-28 pb-20">
        ...
        {/* Main headline */}
        <motion.h1
          className="font-display text-display-xl md:text-display-2xl font-bold text-text-primary leading-[1.05] max-w-4xl mb-6"
          initial={shouldReduceMotion ? {} : { opacity: 0, y: 24 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.7, delay: 0.1, ease: [0.16, 1, 0.3, 1] }}
        >
          Master the Markets.{' '}
          <span className="text-gold-gradient">Build Your Wealth.</span>
        </motion.h1>
        ...
        >
          Free trading education, live market insights, and thriving communities
          — by{' '}
          <span className="text-text-primary font-semibold">Aasim Majeed AMC</span>,
          Financial Consultant with 5 years of experience.
        </motion.p>
